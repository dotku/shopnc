...
<?php }?>	  
    ...
    <ul>
      ...
      <li class="ncs-info-btn-qrcode"><a href="javascript:void(0)" class="pngFix"><span>店铺二维码</span><b></b> <!-- 店铺二维码 -->
        <p class="ncs-info-qrcode"><img src="http://qr.liantu.com/api.php?&el=l&w=208&m=10&text=<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>"></p>
        </a></li>
    </ul>
    </div> 
  </div>
