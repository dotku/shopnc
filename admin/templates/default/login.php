...
<script type="text/javascript">
    $(function() {
        ...
        $('.input-button').click(function(e) {
            $('.input-username,dot-left').addClass('animated fadeOutRight') $('.input-password-box,dot-right').addClass('animated fadeOutLeft') $('.input-button').addClass('animated fadeOutUp') setTimeout(function() {
