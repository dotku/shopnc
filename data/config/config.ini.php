...
$config = array();
$config['base_site_url'] = __FILE__ . "../..";
// $config['base_site_url'] 		= $config['base_site_url'] . '';
...
$config['setup_date'] 	= '2015-05-28 15:00:08';
$config['gip'] 			= 0;
...
$config['db']['1']['dbname']       = 'v3-b10';
$config['db']['1']['dbcharset']    = 'UTF-8';
$config['db']['slave']                  = $config['db']['master'];
$config['session_expire'] 	= 3600;
$config['lang_type'] 		= 'zh_cn';
$config['cookie_pre'] 		= '9968_';
